...
const AddTask = ({ route, navigation }) => {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      axios.get("https://edu2-8cd5y.ondigitalocean.app/api/users/" + global.user.id + "/categories")
        .then(response => {
      ...
      >
        ...
        <View style={styles.dropDown}>
          ...
          <SelectDropdown
            ...
            options={[...categories, {id:0, name:"Add new category"}]}
            initialSelected={categories[0].id}
          />
          {dropdownValue == 0 ? <InputField
